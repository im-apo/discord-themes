...
All Nexus themes include:

- 🌈 **Animated Gradient Backgrounds** - Dynamic color shifts
- ✨ **Glowing Effects** - Neon-style glows on interactive elements
- 🎯 **Server Icon Animations** - Hover and selection effects
- 📱 **Responsive Design** - Works across all Discord layouts
- 🎨 **Custom Scrollbars** - Themed to match accent colors
- 💬 **Enhanced Message Input** - Glowing focus effects
- 🔍 **Styled Search Bars** - Consistent theme integration
...
2. Download your preferred theme from this repository
3. Open Discord Settings → BetterDiscord → Themes
4. Click "Open Theme Folder"
5. Move the downloaded `.theme.css` file into the folder
...
:root {
  ...
  --background-accent: #ff0080;
  /* Modify these values to customize colors */
}
```

### Attack on Titan Theme Variables:
```css
...
- Server list with glowing effects
- Channel sidebar and chat area
...
|-------|-------------|-----------|------------|----------|
| **Neon Nexus** | Pink/Cyan | High | Energetic | Cyberpunk enthusiasts |
| **Cyber Nexus** | Purple/Blue | Medium | Sophisticated | Refined aesthetics |
...
### Ruby Nexus
```
Primary:   #dc0000 (Crimson Red)
Secondary: #8b0000 (Dark Red)
Background: #0a0000 (Pure Black)
```

### Solar Nexus
```
Primary:   #ff6600 (Vibrant Orange)
Secondary: #dc3200 (Orange-Red)
Background: #0a0500 (Very Dark Brown)
```
